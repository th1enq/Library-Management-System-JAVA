...
-- Horror (4 books)
('Dracula', 'Bram Stoker', 'Archibald Constable and Company', '1897-05-26', 'http://books.google.com/books/content?id=39lCAQAAMAAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', '9781435159570', 'The story of the famous vampire', '418', 'Horror', '12.99', 'English', 'https://play.google.com/store/books/details/Abraham_Stoker_Dracula?id=vNR8CwAAQBAJ', 5),
('Frankenstein', 'Mary Shelley', 'Lackington, Hughes, Harding, Mavor & Jones', '1818-01-01', 'http://books.google.com/books/content?id=9xHCAgAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', '9780486282114', 'The story of Victor Frankenstein and his monstrous creation', '280', 'Horror', '9.99', 'English', 'https://play.google.com/store/books/details/Mary_Shelley_Frankenstein?id=9xHCAgAAQBAJ',  5),
('The Shining', 'Stephen King', 'Doubleday', '1977-01-28', 'http://books.google.com/books/content?id=VR5eEAAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', '9780385121675', 'A family isolated in a haunted hotel', '447', 'Horror', '10.99', 'English', 'https://play.google.com/store/books/series?id=NBCoGwAAABCdCM', 5),
('It', 'Stephen King', 'Viking', '1986-09-15', 'http://books.google.com/books/content?id=fVWQDQAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', '9780450411434', 'A group of kids facing a monster', '1138', 'Horror', '14.99', 'English', 'https://play.google.com/store/books/details/Stephen_King_It?id=-rUACwAAQBAJ',  5),
-- Self-Help (2 books)
('The Power of Now', 'Eckhart Tolle', 'New World Library', '1997-10-01', 'http://books.google.com/books/content?id=QFQ7DwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', '9781577314806', 'A guide to spiritual enlightenment and living in the present moment.', '229', 'Self-Help', '14.99', 'English', 'https://www.amazon.com/Power-Now-Guide-Spiritual-Enlightenment/dp/1577314808', 5),
('Atomic Habits', 'James Clear', 'Penguin', '2018-10-16', 'http://books.google.com/books/content?id=Jrx6EAAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', '9780735211292', 'A proven way to build good habits and break bad ones.', '320', 'Self-Help', '18.99', 'English', 'https://www.amazon.com/Atomic-Habits-Proven-Build-Break/dp/0735211299',5);
...
(1, 1, 'Naruto', '2024-11-01 08:00:00', '2024-11-11 08:00:00'),
(2, 2, 'Dracula', '2024-11-02 08:00:00', '2024-11-12 08:00:00'),
(3, 3, 'Time', '2024-11-03 08:00:00', '2024-11-13 08:00:00'),
(4, 1, 'Forbes', '2024-11-04 08:00:00', '2024-11-14 08:00:00'),
(5, 2, 'Naruto', '2024-11-05 08:00:00', '2024-11-15 08:00:00'),
(6, 3, 'Dracula', '2024-11-06 08:00:00', '2024-11-16 08:00:00'),
(7, 1, 'Time', '2024-11-07 08:00:00', '2024-11-17 08:00:00'),
(8, 2, 'Forbes', '2024-11-08 08:00:00', '2024-11-18 08:00:00'),
(9, 3, 'Naruto', '2024-11-09 08:00:00', '2024-11-19 08:00:00'),
...
(8, 2, 'Naruto', '2024-11-08 08:00:00', '2024-11-18 08:00:00', 0),
(9, 3, 'Naruto', '2024-11-09 08:00:00', '2024-11-19 08:00:00', 1),
(10, 1, 'Forbes', '2024-11-10 08:00:00', '2024-11-20 08:00:00', 0);



INSERT INTO `borrow_slip` (`id`, `user_id`, `book_name`, `borrow_date`, `return_date`) VALUES
(1, 1, 'Naruto', '2024-11-01 08:00:00', '2024-11-11 08:00:00'),
(2, 2, 'Forbes', '2024-11-02 08:00:00', '2024-11-12 08:00:00'),
(3, 3, 'Dracula', '2024-11-03 08:00:00', '2024-11-13 08:00:00'),
