...
/**
 * Lớp này đại diện cho một yêu cầu mượn sách trong hệ thống.
 * Nó kế thừa từ lớp {@link BookIssue} và bổ sung thêm các thông tin về ID của yêu cầu và trạng thái chấp nhận.
 *
 * @see BookIssue
 */
public class BorrowRequest extends BookIssue {
  ...
  /**
   * Khởi tạo một đối tượng {@link BorrowRequest} với các giá trị mặc định.
   * Phương thức này gọi đến constructor của lớp {@link BookIssue} với các giá trị mặc định.
   */
  ...
  /**
   * Khởi tạo một đối tượng {@link BorrowRequest} với các giá trị cụ thể.
   * Phương thức này gọi đến constructor của lớp {@link BookIssue} với các thông tin cơ bản như userId, username, bookTitle, bookAuthor, issueDate, returnDate.
   *
  ...
  /**
   * Trả về chuỗi mô tả thông tin của yêu cầu mượn sách.
   * Mô tả chi tiết bao gồm ID của yêu cầu, ID người dùng, tên người dùng, tiêu đề sách, tác giả, ngày mượn, ngày trả, trạng thái và trạng thái chấp nhận.
   *
