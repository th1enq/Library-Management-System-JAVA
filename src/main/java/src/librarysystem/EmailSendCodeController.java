  ...
  public void initialize() {
    ...
    submitCode.setOnAction(actionEvent -> {
      ...
      if (PasswordRecoveryService.checkToken(userEmail.getText(), emailCode.toString())) {
        ...
        firstNum.setStyle(
            "-fx-focus-color: transparent; -fx-faint-focus-color: transparent; -fx-border-color: red; -fx-background-radius: 10; -fx-border-radius: 10; -fx-border-width: 2;");
        secondNum.setStyle(
            "-fx-focus-color: transparent; -fx-faint-focus-color: transparent; -fx-border-color: red; -fx-background-radius: 10; -fx-border-radius: 10; -fx-border-width: 2;");
        thirdNum.setStyle(
            "-fx-focus-color: transparent; -fx-faint-focus-color: transparent; -fx-border-color: red; -fx-background-radius: 10; -fx-border-radius: 10; -fx-border-width: 2;");
  ...
  private void setupCodeInput(TextField currentField, TextField prevField, TextField nextField) {
    ...
    currentField.setOnKeyTyped(event -> {
      ...
      if (!input.matches("\\d")) {
        ...
        currentField.setStyle(
            "-fx-focus-color: transparent; -fx-faint-focus-color: transparent; -fx-border-color: #748FD2; -fx-background-radius: 10; -fx-border-radius: 10; -fx-border-width: 2;");
        if (nextField != null) {
