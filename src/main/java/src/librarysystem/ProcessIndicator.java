...
public class ProcessIndicator {
    ...
    public Pane loadLoadingScreen() {
        ...
        Timeline progressTimeline = new Timeline(
                new KeyFrame(Duration.ZERO, new KeyValue(progressCircle.strokeDashOffsetProperty(), circumference)),
                new KeyFrame(Duration.seconds(2), new KeyValue(progressCircle.strokeDashOffsetProperty(), 0)),
        ...
        for (int i = 0; i <= steps; i++) {
            ...
            KeyFrame keyFrame = new KeyFrame(Duration.seconds(i * 3.0 / steps),
                    ...
                    new KeyValue(progressCircle.strokeDashOffsetProperty(), circumference - (progress / 100) * circumference));
