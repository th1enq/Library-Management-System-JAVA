...
/**
 * Lớp này đại diện cho một cặp khóa-giá trị, nơi mỗi cặp có một khóa và một giá trị
 * có thể là bất kỳ kiểu dữ liệu nào.
 * Cặp khóa-giá trị này hữu ích khi cần lưu trữ dữ liệu liên kết với nhau.
 *
