...
/**
 * Lớp này quản lý các biểu đồ thống kê liên quan đến số lượt đăng nhập và phân loại sách trong hệ
 * thống. Nó cung cấp các phương thức để cập nhật và lấy dữ liệu cần thiết cho các biểu đồ.
 */
public class ChartController {

  /**
   * Cập nhật số lượng đăng nhập trong một ngày cụ thể trong cơ sở dữ liệu. Phương thức này tăng số
   * lượng đăng nhập cho ngày đã cho.
   *
  ...
  /**
   * Lấy dữ liệu về số lượt đăng nhập trong tuần, mỗi ngày được biểu diễn bởi một đối tượng
   * {@link XYChart.Data}. Dữ liệu này được sử dụng để vẽ biểu đồ đường hoặc cột cho số lượt đăng
   * nhập theo từng ngày.
   *
  ...
  /**
   * Lấy dữ liệu để vẽ biểu đồ tròn (pie chart) với số lượng sách phân loại. Phương thức này lấy dữ
   * liệu về số lượng sách theo từng loại và tạo ra các đối tượng {@link PieChart.Data} để sử dụng
   * trong biểu đồ tròn. Ngoài ra, còn tính toán và thêm một phần "Other" nếu còn số sách không
   * thuộc 4 loại phổ biến nhất.
   *
